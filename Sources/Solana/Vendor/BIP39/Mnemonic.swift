...
public class Mnemonic {
    ...
    /**
     This checks if the phrase is generated by a valid given the wordlist. When you are generating a BIP39 phrase, the last word is supposed
     to encode a checksum. So this checks the checksum.

     Note: this should not be used to block someone from creating an account because someone may have generated a phrase with a different
     wordlist *or* they may have accidentally used an algorithm to generate it that didn't get the checksum correct.

     You can go from Mnemonic → seed without a valid phrase.
     */
    public static func isValidPhrase(phrase: [String], wordlist: [String] = Wordlists.english) -> Bool {
        var bits = ""
        for word in phrase {
